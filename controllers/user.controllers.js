...
const register = async (req, res, next) => {
  ...
  const user = await User.create({
    ...
    avatar: {
      ...
      //secure_url: 'C:\\Users\\bhave\\OneDrive\\Pictures\\IMG_20230815_100656.jpg',
    },
  });
...
const getProfile = async (req, res) => {
  try {
    ...
    return next(
      new AppError("Failed to fetch profile details or user details.", 500)
    );
  }
};
...
const forgotPassword = async (req, res, next) => {
    ...
    try {
        ...
        await user.save();
        return next(new AppError('Something went wrong, please try again.' || e.message, 500));
    }
